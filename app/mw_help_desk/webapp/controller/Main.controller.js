sap.ui.define([
    ...
    "sap/ui/model/Sorter",
    "sap/base/Log",
    "megawork/mwhelpdesk/model/formatter"
    ...
    return Controller.extend("megawork.mwhelpdesk.controller.Main", {
        ...
        async onNotificationPress(oEvent) {
            if (!this._pPopoverNotificacoes) {
                this._pPopoverNotificacoes = this.loadFragment({
                    name: "megawork.mwhelpdesk.view.Notificacoes"
                }).catch((oError) => {
            ...
            try {
                ...
                Log.error("Falha ao carregar o popover de notificacoes", oError,
                    "megawork.mwhelpdesk.controller.Main");
            }
        },
        ...
        async onDetalheAbrirChamadoSap() {
            ...
            if (!this._pDialogChamadoSap) {
                ...
                this._pDialogChamadoSap = this.loadFragment({
                    name: "megawork.mwhelpdesk.view.AbrirChamadoSap"
                }).catch((oError) => {
            ...
            try {
                ...
                if (String(oModelo.getProperty("/origemId") ?? "").trim() !== sOrigemId
                    ...
                    Log.warning("Abertura de chamado SAP abandonada: o dialogo mudou durante a espera",
                        sOrigemId, "megawork.mwhelpdesk.controller.Main");
                    return;
                }
            ...
            try {
                ...
                if (!oResultado || oResultado.falha === true || oResultado.atualizado !== true) {
                    Log.warning("Componente SAP nao propagado para o header do chamado " + sObjectID,
                        String(oResultado?.mensagem ?? ""), "megawork.mwhelpdesk.controller.Main");
                    return "erro";
                }
        ...
        _finalizarChamado() {
            ...
            this._criarTicket(oData).then((oCriado) => {
                ...
                Log.error("Falha ao criar o chamado no backend", oError, "megawork.mwhelpdesk.controller.Main");
        ...
        _lerUsuarioLogado() {
            ...
            //         undefined, "megawork.mwhelpdesk.controller.Main");
        ...
        _carregarRequisitante() {
            ...
            return this._lerUsuarioLogado().then((sEmail) => {
                ...
                Log.error("Falha ao carregar o requisitante", oError, "megawork.mwhelpdesk.controller.Main");
            ...
            return this._lerSUserRequisitante()
                ...
                .catch((oError) => {
                    Log.error("Falha ao carregar os comentarios do caso SAP " + sCorrelationId,
                        oError, "megawork.mwhelpdesk.controller.Main");
                ...
                .then((oComentarios) => {
                    ...
                    if (oComentarios.truncado === true) {
                        Log.warning("Caso " + sCorrelationId + ": " + oComentarios.total
                            ...
                            null, "megawork.mwhelpdesk.controller.Main");
                    }
